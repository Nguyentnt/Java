...
what 30-year mortgage eligibility and interest rate qualify for */
   ...
   int average = (TransUnion + Equifax + Experian)/3;
...
interest rate of 3.50%.  Any less than 579 or below will not eligible for mortgage, no interest rate will be provided. */
   ...
   if(average >= 740 && average <= 850) {   
      System.out.println("Congraulations!  You are eligbile for the 30-year mortgage at the interest rate of 2.75%");
      
   else(average >=670 && average <= 739) {
